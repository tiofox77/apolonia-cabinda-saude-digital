              ...
              >
                ...
                <div className="relative p-8">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-gray-100 group-hover:border-gray-200 transition-colors duration-300">
                    <span className={`text-${specialty.accent}-600 font-bold text-sm group-hover:underline transition-all duration-300`}>
                      Saiba mais
                    </span>
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${specialty.color} flex items-center justify-center transition-all duration-700 ${
                  ...
                  <div className="text-center text-white p-8 transform scale-90 group-hover:scale-100 transition-transform duration-500">
                    ...
                    <div className="space-y-4">
                      <button className="w-full bg-white/20 backdrop-blur-xl text-white px-8 py-4 rounded-2xl font-bold hover:bg-white/30 transition-all duration-300 border border-white/30 hover:border-white/50">
                        Agendar Consulta
                      </button>
                      <button className="w-full border-2 border-white/30 text-white px-8 py-3 rounded-2xl font-semibold hover:bg-white/10 transition-all duration-300">
                        Ver Mais Detalhes
                      </button>
                    </div>
                  </div>
