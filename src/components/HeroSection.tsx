            ...
            <div className="text-white animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-12">
                <button 
                  ...
                  className="group bg-white text-blue-900 px-8 py-4 rounded-2xl hover:bg-blue-50 transition-all duration-300 text-lg font-bold shadow-xl hover:shadow-2xl hover:scale-105 flex items-center justify-center gap-3"
                >
